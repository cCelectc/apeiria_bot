...
<template>
  <div class="divide-y divide-border">
    <template v-for="field in sortedFields" :key="field.key">
      <!-- PrimitiveField -->
      <div v-if="field.kind === 'primitive'" class="py-4 first:pt-0 last:pb-0 space-y-2">
      ...
      <!-- ObjectField -->
      <div v-if="field.kind === 'object'" class="py-4 first:pt-0 last:pb-0 space-y-2">
      ...
      <!-- ArrayField -->
      <div v-if="field.kind === 'array'" class="py-4 first:pt-0 last:pb-0 space-y-2">
        <div class="flex items-center gap-2">
          <span class="text-sm font-semibold">{{ field.label }}</span>
          <span class="rounded-sm bg-accent px-1.5 py-0.5 text-xs font-medium text-accent-foreground">
      ...
      <!-- MapField -->
      <div v-if="field.kind === 'map'" class="py-4 first:pt-0 last:pb-0 space-y-2">
        <div class="flex items-center gap-2">
          <span class="text-sm font-semibold">{{ field.label }}</span>
          <span class="rounded-sm bg-accent px-1.5 py-0.5 text-xs font-medium text-accent-foreground">
      ...
      <!-- AnyField -->
      <div v-if="field.kind === 'any'" class="py-4 first:pt-0 last:pb-0 space-y-2">
        <div class="flex items-center gap-2">
