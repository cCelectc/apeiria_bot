...
from apeiria.interfaces.http.routes.ai_future_tasks_routes import (
    router as _future_tasks_router,
)
from apeiria.interfaces.http.routes.ai_memories_routes import (
    router as _memories_router,
)
from apeiria.interfaces.http.routes.ai_models_routes import router as _models_router
from apeiria.interfaces.http.routes.ai_person_profiles_routes import (
    router as _person_profiles_router,
)
from apeiria.interfaces.http.routes.ai_personas_routes import (
    router as _personas_router,
)
from apeiria.interfaces.http.routes.ai_relationships_routes import (
    router as _relationships_router,
)
from apeiria.interfaces.http.routes.ai_sessions_routes import (
    router as _sessions_router,
)
from apeiria.interfaces.http.routes.ai_sources_routes import (
