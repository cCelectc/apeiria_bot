"""AITTSModel model - persisted text-to-speech model entries under one source."""
...
class AITTSModel(Model):
    """One persisted TTS model entry owned by one AI source."""
    ...
    __table_args__ = (
        UniqueConstraint(
            "source_id",
            "model_identifier",
            name="uq_ai_tts_model_source_identifier",
        ),
    )
