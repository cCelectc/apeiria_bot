"""AISTTModel model - persisted speech-to-text model entries under one source."""
...
class AISTTModel(Model):
    """One persisted STT model entry owned by one AI source."""
    ...
    __table_args__ = (
        UniqueConstraint(
            "source_id",
            "model_identifier",
            name="uq_ai_stt_model_source_identifier",
        ),
    )
