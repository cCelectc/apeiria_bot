"""AIRerankModel model - persisted rerank model entries under one source."""
...
class AIRerankModel(Model):
    """One persisted rerank model entry owned by one AI source."""
    ...
    __table_args__ = (
        UniqueConstraint(
            "source_id",
            "model_identifier",
            name="uq_ai_rerank_model_source_identifier",
        ),
    )
