...
model_capability_template_registry = ModelCapabilityTemplateRegistry(
    (
        ModelCapabilityTemplate(
            template_id="openai-gpt-4o-chat",
            adapter_kind="openai_compatible",
            identifier_patterns=("gpt-4o*", "gpt-4.1*"),
            priority=100,
            capability_metadata=_CHAT_TEMPLATE_METADATA,
            detail="OpenAI compatible GPT-4o/4.1 chat family",
        ),
        ModelCapabilityTemplate(
            template_id="openrouter-openai-gpt-4o-chat",
            adapter_kind="openai_compatible",
            source_hints=("openrouter",),
            identifier_patterns=("openai/gpt-4o*", "openai/gpt-4.1*"),
            priority=110,
            capability_metadata=_CHAT_TEMPLATE_METADATA,
            detail="OpenRouter OpenAI GPT-4o/4.1 chat family",
        ),
        ModelCapabilityTemplate(
            template_id="anthropic-claude-3-chat",
            adapter_kind="anthropic_compatible",
            identifier_patterns=("claude-3*",),
            priority=100,
            capability_metadata={
                **_CHAT_TEMPLATE_METADATA,
                "json_mode": False,
                "supported_options": ["temperature", "max_tokens", "tool_choice"],
            },
            detail="Anthropic compatible Claude 3 chat family",
        ),
    )
)
