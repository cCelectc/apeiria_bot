...
from apeiria.db.models.ai_source import AISTTModel
...
class AISTTModelService:
    ...
    async def get_model(
        ...
        *,
        ...
        record = await get_source_model(AISTTModel, model_id=model_id)
        return (
    ...
    async def list_models(
        ...
        *,
        ...
        return [
            ...
            for row in await list_source_models(AISTTModel, source_id=source_id)
        ]
    ...
    async def create_model(
        ...
        return AISpeechToTextModelDefinition(**record.__dict__)
    ...
    async def delete_model(
        ...
        *,
        ...
        return await delete_source_model(AISTTModel, model_id=model_id)
