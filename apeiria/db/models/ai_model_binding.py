"""AIModelBinding model — persisted model profile bindings by scope."""
...
class AIModelBinding(Model):
    """One persisted model profile binding."""
    ...
    __table_args__ = (
        UniqueConstraint(
            "scope_type",
            "scope_id",
            name="uq_ai_model_binding_scope",
        ),
    )
