"""AIChatModel model — persisted chat model entries under one source."""
...
class AIChatModel(Model):
    """One persisted chat model entry owned by one AI source."""
    ...
    __table_args__ = (
        UniqueConstraint(
            "source_id",
            "model_identifier",
            name="uq_ai_chat_model_source_identifier",
        ),
    )
