...
class RuntimeTurnInput:
    ...
    @classmethod
    def from_reply_request(
        cls,
        request: "AIRuntimeReplyRequest",
    ) -> "RuntimeTurnInput":
        """Translate the legacy ingress DTO into a runtime-owned turn input."""
    ...
    def to_reply_request(self) -> "AIRuntimeReplyRequest":
        """Translate this runtime input back for legacy ingress-local helpers."""
...
class RuntimeContextMaterials:
    ...
    @classmethod
    def from_reply_inputs(
        cls,
        inputs: "ReplyInputs",
    ) -> "RuntimeContextMaterials":
        """Translate legacy collector output into runtime-owned context materials."""
