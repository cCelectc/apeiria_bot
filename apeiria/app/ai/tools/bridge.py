"""Whitelist-based NoneBot capability bridge skeleton."""
...
class AINoneBotCapabilityBridge:
    ...
    This bridge does not expose arbitrary command execution. Only explicitly
    registered capability names may be invoked.
    """
