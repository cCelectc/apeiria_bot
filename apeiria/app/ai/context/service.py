"""Context kernel service for AI conversation identity and turn ingestion."""
...
from apeiria.app.ai.context.identity import (
    build_conversation_identity_from_event,
    trim_turn_window,
)
from apeiria.app.ai.context.models import (
    AIContextTurnView,
...
class AIContextService:
    """Context kernel service for conversation upsert and turn append."""
