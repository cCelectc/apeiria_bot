  ...
  <div class="page-view">
    ...
    <div class="page-summary-grid mb-4">
      <v-sheet class="summary-card" rounded="lg">
        <div class="summary-card__label">{{ t('ai.capabilities') }}</div>
        <div class="summary-card__value">{{ capabilities.length }}</div>
      </v-sheet>
      <v-sheet class="summary-card" rounded="lg">
        <div class="summary-card__label">{{ t('ai.tools') }}</div>
        <div class="summary-card__value">{{ tools.length }}</div>
      </v-sheet>
      <v-sheet class="summary-card" rounded="lg">
        <div class="summary-card__label">{{ t('ai.policyBindings') }}</div>
        <div class="summary-card__value">{{ bindings.length }}</div>
      </v-sheet>
      <v-sheet class="summary-card" rounded="lg">
